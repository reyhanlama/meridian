...
// Major world cities with coordinates [lng, lat]
export const CITIES: { name: string; country: string; lng: number; lat: number }[] = [
  ...
  { name: "Montreal", country: "Canada", lng: -73.57, lat: 45.50 },
  ...
  { name: "Kinshasa", country: "DR Congo", lng: 15.27, lat: -4.44 },
  ...
  { name: "Abu Dhabi", country: "United Arab Emirates", lng: 54.37, lat: 24.45 },
  ...
  { name: "Lhasa", country: "China", lng: 91.11, lat: 29.65 },
  { name: "Anchorage", country: "United States", lng: -149.90, lat: 61.22 },
  // Additional cities for precision
  ...
  { name: "Philadelphia", country: "United States", lng: -75.17, lat: 39.95 },
  ...
  { name: "Guadalajara", country: "Mexico", lng: -103.35, lat: 20.67 },
  { name: "Monterrey", country: "Mexico", lng: -100.31, lat: 25.67 },
  ...
  { name: "Montevideo", country: "Uruguay", lng: -56.16, lat: -34.88 },
  { name: "Caracas", country: "Venezuela", lng: -66.90, lat: 10.49 },
  { name: "La Paz", country: "Bolivia", lng: -68.15, lat: -16.50 },
  { name: "Asunción", country: "Paraguay", lng: -57.58, lat: -25.26 },
  { name: "San José", country: "Costa Rica", lng: -84.08, lat: 9.93 },
  ...
  { name: "Frankfurt", country: "Germany", lng: 8.68, lat: 50.11 },
  ...
  { name: "Islamabad", country: "Pakistan", lng: 73.05, lat: 33.69 },
  ...
  { name: "Hyderabad", country: "India", lng: 78.47, lat: 17.39 },
  ...
  { name: "Vientiane", country: "Laos", lng: 102.63, lat: 17.97 },
  { name: "Chiang Mai", country: "Thailand", lng: 98.98, lat: 18.79 },
  { name: "Phuket", country: "Thailand", lng: 98.39, lat: 7.88 },
  { name: "Shenzhen", country: "China", lng: 114.06, lat: 22.54 },
  { name: "Chengdu", country: "China", lng: 104.07, lat: 30.57 },
  { name: "Guangzhou", country: "China", lng: 113.26, lat: 23.13 },
  { name: "Xi'an", country: "China", lng: 108.94, lat: 34.26 },
  { name: "Busan", country: "South Korea", lng: 129.08, lat: 35.18 },
  { name: "Sapporo", country: "Japan", lng: 141.35, lat: 43.06 },
  ...
  { name: "Bamako", country: "Mali", lng: -8.00, lat: 12.64 },
  { name: "Ouagadougou", country: "Burkina Faso", lng: -1.52, lat: 12.37 },
  { name: "Douala", country: "Cameroon", lng: 9.77, lat: 4.05 },
  { name: "Algiers", country: "Algeria", lng: 3.04, lat: 36.75 },
  { name: "Tripoli", country: "Libya", lng: 13.18, lat: 32.90 },
  ...
  // --- Additional cities for better global coverage ---
  // Russia (vast territory needs more points)
  { name: "Novosibirsk", country: "Russia", lng: 82.93, lat: 55.03 },
  { name: "Yekaterinburg", country: "Russia", lng: 60.60, lat: 56.84 },
  { name: "Vladivostok", country: "Russia", lng: 131.89, lat: 43.12 },
  { name: "Krasnoyarsk", country: "Russia", lng: 92.87, lat: 56.01 },
  { name: "Irkutsk", country: "Russia", lng: 104.30, lat: 52.29 },
  { name: "Murmansk", country: "Russia", lng: 33.09, lat: 68.97 },
  { name: "Kazan", country: "Russia", lng: 49.12, lat: 55.80 },
  { name: "Sochi", country: "Russia", lng: 39.72, lat: 43.60 },
  // China (interior coverage)
  { name: "Kunming", country: "China", lng: 102.68, lat: 25.04 },
  { name: "Wuhan", country: "China", lng: 114.31, lat: 30.59 },
  { name: "Harbin", country: "China", lng: 126.65, lat: 45.75 },
  { name: "Urumqi", country: "China", lng: 87.62, lat: 43.83 },
  // South America (interior)
  { name: "Brasília", country: "Brazil", lng: -47.93, lat: -15.78 },
  { name: "Manaus", country: "Brazil", lng: -60.03, lat: -3.12 },
  { name: "Recife", country: "Brazil", lng: -34.87, lat: -8.05 },
  { name: "Salvador", country: "Brazil", lng: -38.51, lat: -12.97 },
  { name: "Córdoba", country: "Argentina", lng: -64.18, lat: -31.42 },
  { name: "Cusco", country: "Peru", lng: -71.97, lat: -13.53 },
  // Africa (interior & underrepresented)
  { name: "Luanda", country: "Angola", lng: 13.23, lat: -8.84 },
  { name: "Antananarivo", country: "Madagascar", lng: 47.52, lat: -18.88 },
  ...
  { name: "N'Djamena", country: "Chad", lng: 15.04, lat: 12.13 },
  ...
  // Middle East
  { name: "Ankara", country: "Turkey", lng: 32.87, lat: 39.93 },
  { name: "Baku", country: "Azerbaijan", lng: 49.87, lat: 40.41 },
  { name: "Sana'a", country: "Yemen", lng: 44.21, lat: 15.35 },
  { name: "Damascus", country: "Syria", lng: 36.29, lat: 33.51 },
  // Southeast Asia
  { name: "Surabaya", country: "Indonesia", lng: 112.75, lat: -7.25 },
  { name: "Cebu", country: "Philippines", lng: 123.90, lat: 10.32 },
  { name: "Da Nang", country: "Vietnam", lng: 108.21, lat: 16.07 },
  // Pacific / Island
  { name: "Port Moresby", country: "Papua New Guinea", lng: 147.15, lat: -9.44 },
  { name: "Nouméa", country: "New Caledonia", lng: 166.46, lat: -22.28 },
  // Europe (gaps)
  { name: "Minsk", country: "Belarus", lng: 27.57, lat: 53.90 },
  { name: "Chisinau", country: "Moldova", lng: 28.86, lat: 47.01 },
  { name: "Tirana", country: "Albania", lng: 19.82, lat: 41.33 },
  { name: "Skopje", country: "North Macedonia", lng: 21.43, lat: 42.00 },
  { name: "Sarajevo", country: "Bosnia and Herzegovina", lng: 18.41, lat: 43.86 },
  { name: "Ljubljana", country: "Slovenia", lng: 14.51, lat: 46.06 },
  { name: "Bratislava", country: "Slovakia", lng: 17.11, lat: 48.15 },
  { name: "Nicosia", country: "Cyprus", lng: 33.38, lat: 35.17 },
  // Central America / Caribbean
  { name: "Santo Domingo", country: "Dominican Republic", lng: -69.94, lat: 18.49 },
  { name: "Port-au-Prince", country: "Haiti", lng: -72.34, lat: 18.54 },
  { name: "Guatemala City", country: "Guatemala", lng: -90.53, lat: 14.63 },
  { name: "Tegucigalpa", country: "Honduras", lng: -87.22, lat: 14.07 },
  { name: "Managua", country: "Nicaragua", lng: -86.25, lat: 12.13 },
  { name: "San Salvador", country: "El Salvador", lng: -89.19, lat: 13.69 },
  // Central Asia
  { name: "Bishkek", country: "Kyrgyzstan", lng: 74.59, lat: 42.87 },
  { name: "Dushanbe", country: "Tajikistan", lng: 68.77, lat: 38.56 },
  { name: "Ashgabat", country: "Turkmenistan", lng: 58.38, lat: 37.96 },
  { name: "Astana", country: "Kazakhstan", lng: 71.43, lat: 51.17 },
  // South Asia
  { name: "Thimphu", country: "Bhutan", lng: 89.64, lat: 27.47 },
];
